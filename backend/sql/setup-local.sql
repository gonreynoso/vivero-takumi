-- Ejecutar como administrador de MySQL (una sola vez).
-- En Linux suele ser: sudo mysql

CREATE DATABASE IF NOT EXISTS vivero_takumi CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE USER IF NOT EXISTS 'vivero'@'localhost' IDENTIFIED BY 'vivero123';
GRANT ALL PRIVILEGES ON vivero_takumi.* TO 'vivero'@'localhost';
FLUSH PRIVILEGES;
