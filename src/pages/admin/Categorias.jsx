              ...
              {editando === categoria ? (
                <>
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded-lg px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-accent"
                  />
                  <button onClick={guardarEdicion} className="text-primary hover:text-primary/70" aria-label="Guardar">
                    <Check className="w-4 h-4" />
                  </button>
                  <button onClick={() => setEditando(null)} className="text-gray-400 hover:text-gray-600" aria-label="Cancelar">
                    <X className="w-4 h-4" />
                  </button>
                </>
              ) : (
                <>
                  <span className="flex-1 text-gray-700">{categoria}</span>
