...
const itemsPorRol = {
  cliente: [
    ...
    { to: '/mis-pedidos', label: 'Pedidos', icon: Package, gradient: 'radial-gradient(circle, rgba(82,183,136,0.25) 0%, rgba(82,183,136,0.08) 50%, transparent 100%)' },
    { to: '/mis-plantas', label: 'Plantas', icon: Sprout, gradient: 'radial-gradient(circle, rgba(82,183,136,0.25) 0%, rgba(82,183,136,0.08) 50%, transparent 100%)' },
